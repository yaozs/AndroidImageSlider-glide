...
////
        if (mUrl != null) {
            ...
            Glide.with(mContext).load(mFile).listener(new RequestListener<File, GlideDrawable>() {
                @Override
            ...
            Glide.with(mContext).load(mRes).listener(new RequestListener<Integer, GlideDrawable>() {
                @Override
